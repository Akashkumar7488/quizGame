...
const Navbar = () => {
  ...
  return (
    ...
    <nav className='fixed w-full h-20 shadow-xl bg-blue-400'>
        <div className='flex justify-between items-center h-full w-full px-4 2xl:px-16'>
            ...
            <div onClick={handleNav} className='sm:hidden cursor-pointer pl-24'><AiOutlineMenu size={35}/>
            </div>
        </div>
        <div className={
            menuOpen
            ? "fixed left-0 top-0 w-[65%] sm:hidden h-screen bg-[#3a92d6] p-10 ease-in duration-500"
